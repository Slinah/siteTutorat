...
<body>
    ...
    ?>
        ...
        if (verifExistProposition() != 0) {
            echo '<table class="table striped table-border mt-2" data-role="table" data-show-search="false" data-show-table-info="false" data-show-rows-steps="false" data-pagination-short-mode="false" data-show-pagination="true" data-rows="5">
            <thead>
            <tr>
