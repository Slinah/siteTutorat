...
<body>
    ...
    <div class="container">
        <h3>Graphiques Globaux B1 2019-2020</h3>

        <?php
        if (selectCountCoursByPromo('B1') != 0) {
            echo '<div class="row">
                    <div class="cell-5">
                        Heures de tutorats par matières (B1)
                        <div><canvas id="heuresMat" width="100" height="100"></canvas></div>
                    </div>
                    <div class="cell-5 offset-2">
                        Participants par mois (B1)
                        <div><canvas id="partMois" width="100" height="100"></canvas></div>
                    </div>
                </div>
                <div class="row">
                    <div class="cell-5">
                        Nombre de participants par rapport au nombre d\'inscrits (B1)
                        <div><canvas id="partInsc" width="100" height="100"></canvas></div>
                    </div>
                    <div class="cell-5 offset-2">
                        Nombre de participants par matières (B1)
